...
class Gapps(General):
    dl_links = {
            ...
            "arm64-v8a": ["https://jaist.dl.sourceforge.net/project/opengapps/arm64/20220215/open_gapps-arm64-10.0-pico-20220215.zip", "5dbca3963eb8abe753ef10fb058ab0fd"],
            "armeabi-v7a": ["https://jaist.dl.sourceforge.net/project/opengapps/arm/20220215/open_gapps-arm-10.0-pico-20220215.zip", "1d00ffa4594734d477b10f2e0ee19c0b"]
        }
    arch = host()
